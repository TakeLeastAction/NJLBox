...
!***************************** Control Parameter ********************************
	qLen = 15.0  ! box length  [-qLen, qLen]  
	IperiodicBound = 0  !1 periodic boundary
	iglobal = 2                        !-1:global (central energy density)hadronization 0: local energydensity hadronization
...
!*************************** Parameters  ****************************************
    ...
    nx=31                                                                                   !changed by sunkj
	ny=31                                                                                   !changed by sunkj 
	nz=31                                                                                   !changed by sunkj 
...
! uu,dd,ss is the local condensation which are calculated in comoving reference! 
       ...
       gis=0.0 !gg/2.0           ! gis = Gis
	   gv= 0.0 !gg !gg/4.  !ratio*(2.*gg)  ! gv = 2/3 Gs = - 2 gv   ;  be careful!!!!
       giv =0.0 !-5.0*gg !gg/2.          ! giv = -Giv             ;  be careful!!!!    
...
99  continue
 ...
 49 format(3(1x,i6),1x,f10.4,5(1x,i6))
