...
c---------- get initial hadrons ---------------

		subroutine  gethadron(ixj)
...
c         if(FTar(I).le.0) write(*,*) 'ERROR:FT0<=0',I,FTar(I),ITYPar(I),
c     1        GXar(I),GYar(I),GZar(I),PXar(I),PYar(I),PZar(I),XMar(I)
           enddo
...
clin-3/2009:
         dptemp(I) = dpertp(I)
clin-2/2017 this may cause no particle record in ampt.dat for the event:
         if(FT0(I).le.0)write(6,*) 'ERROR:FT0<=0',Np,I,FT0(I),ITYP0(I),
     1        GX0(I),GY0(I),GZ0(I),PX0(I),PY0(I),PZ0(I),XM0(I)
 1001 CONTINUE
...
cc      SAVE /RNDF77/
      ...
      !WRITE(10,*) MULTI1(K) 
      MULTI1(K) = IAINT2(1)
      WRITE(10,*) 0,0,MULTI1(K),1.,0,0,0,0,0,0,0.
...
c.....analysis subroutine in HIJING before parton cascade evolution
      ...
      PARAMETER (DR = 0.2)
      PARAMETER (MAXPTN=40001,MAXSTR=150001)
